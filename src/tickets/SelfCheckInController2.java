 ...
 */
@WebServlet("/SelfCheckIn2")
public class SelfCheckInController2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelfCheckInController2() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Parameter
		String booked_num = (String) request.getParameter("booked_num");
		b_service.selfCheckIn(new BookedTickets(booked_num, "Y", "", id, 0));
