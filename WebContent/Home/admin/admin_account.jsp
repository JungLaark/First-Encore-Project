...
<h2> Encore Airlines	<em><small>     Log On As Administrator Manage Account. ID : ${sessionScope.id}</small></em></h2>
  ...
  <!-- 본문 -->
	...
	<form action="${pageContext.request.contextPath }/AdminAccController" method="get">
		<fieldset>
			<legend>Encore Airlines DB Management</legend>
			<label> Manage Customer Accounts </label>
			${deletedIds}
			${cleanBoard}
			<br/>click to proceed with Customer account management<br/>
			<br/>
			<br/>
