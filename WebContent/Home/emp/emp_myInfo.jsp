...
<h2> Encore Airlines	<em><small>     Log On As Airlines Staff My Information. ID : ${sessionScope.id}</small></em></h2>
</div>
		...
		<fieldset>
			...
			<div class="form-group">
					...
					<div class="form-group">
						...
						<input
							type="text" class="form-control" id="passportNum" value="${sessionScope.passportNum}" name="passportNum" >
					</div>
