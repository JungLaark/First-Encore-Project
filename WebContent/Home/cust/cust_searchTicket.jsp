...
<h2> Encore Airlines	<em><small>     Log On As Customer Search Tickets. ID : ${sessionScope.id}</small></em></h2>
</div>
...
<div id="page-wrapper">
  ...
  <!-- 본문 -->
	...
	<form action="${pageContext.request.contextPath }/Ticketlist" method="post">
		...
		<input type="submit" class="btn btn-primary"  value="Top10 List">
	</form>
	...
	<h2>Found List</h2>
	<form action="${pageContext.request.contextPath }/SearchTicketList" method="post">
