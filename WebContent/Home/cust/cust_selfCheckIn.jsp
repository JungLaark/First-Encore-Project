...
<h2> Encore Airlines	<em><small>     Log On As Customer Self Check-In. ID : ${sessionScope.id}</small></em></h2>
</div>
  ...
  <!-- 본문 -->
   ...
   <h2>Entire Booked List</h2>
  	<div class="form-group">
		...
		<form action="${pageContext.request.contextPath }/SelfCheckIn" method="post"> 
		<table class="table table-hover">
			...
			<tbody>
				<c:if test="${empty bookedlist}">
					Do not find Searched Information.
				</c:if>
	...
	<h2>Ticket Self-Check In</h2>
	<div class="form-group">
		<form action="${pageContext.request.contextPath }/SelfCheckIn2" method="post">
			<fieldset>
				<div class="form-group">
						<label for="exampleInputEmail1">Booked Num</label>
						 <input type="text"
						class="form-control" id="booked_num" name="booked_num" value="booked_num"
